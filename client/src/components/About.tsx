          ...
          <div className="md:w-1/2">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="social-hover bg-pink-600 text-white w-12 h-12 rounded-full flex items-center justify-center transition-all"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="social-hover bg-black text-white w-12 h-12 rounded-full flex items-center justify-center transition-all"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="social-hover bg-red-600 text-white w-12 h-12 rounded-full flex items-center justify-center transition-all"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="social-hover bg-green-600 text-white w-12 h-12 rounded-full flex items-center justify-center transition-all"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="social-hover bg-blue-600 text-white w-12 h-12 rounded-full flex items-center justify-center transition-all"
              >
